...
<div class="container">
    ...
    <form method="POST">
        ...
        <input type="datetime-local" name="tgl_mendaftar" value="<?= $member['tgl_mendaftar'] ?? '' ?>" required>
